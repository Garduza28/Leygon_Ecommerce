    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card-body">
                        <div class="col-md-6">
                            <h1>Crear Nuevas clasificaciones</h1>

                            <form action="{{ route('admin.storeclasification') }}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img id="imagenSeleccionada"
                                            src="https://cdn-icons-png.flaticon.com/512/84/84099.png"
                                            alt="Vista previa de la imagen" style="max-width: 50%; margin-top: 10px;">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Crear clasificacion</button>
                            </form>
                        @endsection
